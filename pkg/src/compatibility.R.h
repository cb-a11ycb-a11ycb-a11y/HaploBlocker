...
#if ! defined MALLOCX
#define MALLOCX(X) notNull(std::malloc(X), __LINE__, __FILE__)
...
#define AALLOC(X,Y) notNull(std::aligned_alloc(X,Y), __LINE__, __FILE__)
#define CALLOCX(X,Y) notNull(std::calloc(X,Y), __LINE__, __FILE__)
...
#define stopIfRandNotInt stopIfNotInt
#define stopIfRandNotUInt stopIfNotUInt
#define stopIfRandNotAnyInt stopIfNotAnyInt
#define intIfR int
